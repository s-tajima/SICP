...
(define (filter pairs)
  (let ((pair1 (stream-car pairs))
       ...
       (if (= (ramanujan pair1) (ramanujan pair2))
           (cons-stream (ramanujan pair1) (filter (stream-cdr pairs)))
           (filter (stream-cdr pairs)))))

;= Test =================================================================================

(define p (weighted-pairs integers integers ramanujan))
